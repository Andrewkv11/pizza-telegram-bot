...
# dp.messsage_handler(Text(equals='загрузить', ignore_case=True), state=None)
...
# Выход из состояний
# @dp.messsage_handler(state="*", commands='отмена')
# @dp.messsage_handler(Text(equals='отмена', ignore_case=True), state="*")
